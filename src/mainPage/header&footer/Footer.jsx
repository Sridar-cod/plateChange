      ...
      <div className="row  d-flex footer__outter">
        <div className="col-12  col-sm-12 col-md-12 col-lg-4 col-xl-4  col-xxl-4 d-flex flex-column justify-content-center">
          ...
          <div className="d-flex justify-content-around">
            ...
            >
              ...
              <a href="https://mail.google.com/mail/u/1/#inbox?compose=DmwnWtDsVnnDqsxrnLhSnmvGdnlVXNTdkWjvGwMNQqLtsrcSRfmXZMMRvQmwkxBQMXWXXLhhNCVL" target="black">
            <svg
              width={"30px"}
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
            >
              ...
              <a href="https://www.linkedin.com/in/sridar14" target="black">
            <svg
              width={"30px"}
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 448 512"
            >
              ...
              <a href="https://api.whatsapp.com/send/?phone=9360396841&text&type=phone_number&app_absent=0" target="black">
            <svg
              width={"30px"}
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 448 512"
        ...
        <div className="col-12 col-sm-12 col-md-12 col-lg-7 col-xl-7   col-xxl-7 mt-4 me-4 footer__inner">
          <div className="footer__rightTop d-flex justify-content-center flex-column">
            ...
            <button
              className="rightTop__button"
              data-toggle="modal"
              data-target="#signUp"
            >Sign up</button>
            <button
              className="rightTop__button m-0 mt-2"
